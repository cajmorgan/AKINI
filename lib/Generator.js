...
module.exports = class StaticGenerator {
  ...
  get tags() {
    return ["a", "abbr", "acronym", "address", "applet", "area", "article", "aside", "audio", "b", "base", "basefont", "bb", "bdo", "big", "blockquote", "body", "br /", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "command", "datagrid", "datalist", "dd", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "em", "embed", "eventsource", "fieldset", "figcaption", "figure", "font", "footer", "form", "frame", "frameset", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr /", "html", "i", "main", "iframe", "img", "input", "ins", "isindex", "kbd", "keygen", "label", "legend", "li", "link", "map", "mark", "menu", "meta", "meter", "nav", "noframes", "noscript", "object", "ol", "optgroup", "option", "output", "p", "param", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "script", "section", "select", "small", "source", "span", "strike", "strong", "style", "sub", "sup", "table", "tbody", "td", "textarea", "tfoot", "th", "thead", "time", "title", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]
  }
  ...
  _generateElementsFromTree() {
    const root = new Element('div', null, {}, 0);
    const elementsArray = [];
    let priorityArray = [];
    ...
    this.treeObjectArray.forEach((object, index) => {
      ...
      if (object.priority === lowestIndentation) {
        ...
        grandParent = true;
        element = new Element(object.tag, root, object.propertyObject, index + 1);
        ...
        element = new Element(object.tag, parentObject.element, object.propertyObject, index + 1);
      } else if (object.priority <= (previousPriority - 2)) {
  ...
  createTree(input, indentationRule = 2) {
    ...
    return new Component(this.HTMLString, elementsArray)
  }
